...
def transition(node, action):
    ...
    if action == 'RCW': #ring n
        for i in range(n):
            if i < n-k-1 :
                statusAf[(m-1)+i+1] = statusBf[(m-1)+i]
            elif i == n-k-1 :
                statusAf[(k-1)] = statusBf[(m-1)+i]
            elif i >= n-k and i < n-2 :
                statusAf[(m-1)+i+1] = statusBf[(m-1)+i]
            elif i == n-2:
                statusAf[(m-1)] = statusBf[(m-1)+i]
            elif i == n-1:
                statusAf[(m-1)+n-k] = statusBf[(k-1)]
    ...
    if action == 'RCC': #ring n
        for i in range(n):
            if i < n-k-1 :
                statusAf[(m-1)+i] = statusBf[(m-1)+i+1]
            elif i == n-k-1 :
                statusAf[(m-1)+i] = statusBf[(k-1)]
            elif i >= n-k and i < n-2 :
                statusAf[(m-1)+i] = statusBf[(m-1)+i+1]
            elif i == n-2:
                statusAf[(m-1)+i] = statusBf[(m-1)]
            elif i == n-1:
                statusAf[(k-1)] = statusBf[(m-1)+n-k]
